...
module mains_switch_cutout(mains_switch_width = 21.2,
                                mains_switch_height = 30.0,
                                wall_thickness = 3.0) {
    // The mains switch
    translate([mains_switch_width, mains_switch_height/2, -0.5]) 
        cube([mains_switch_width, mains_switch_height, wall+1]);
